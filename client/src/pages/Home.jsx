  ...
  return (
    <Layout>
      ...
      <section className='hook-line' style={{ backgroundColor: '#af99ff' }}>
        <div>
          <h2 style={{ color: '#541f69', fontWeight: 'bold', fontSize: '3xl' }} data-aos='fade-right'>
    ...
    />
      ...
      <section className='steps-path' style={{ padding: '2rem 0' }} data-aos='fade'>
        <h2 style={{ fontSize: '4rem', lineHeight: '1', marginBottom: '1em', textAlign: 'center' }}>How-It-Works</h2>
        <h3 style={{ fontSize: '3xl', color: '#af99ff', marginLeft: '2rem' }} data-aos='fade' data-aos-anchor='.steps-path'>
          Looking to be Hired?
        </h3>
      ...
      <section className='help-section' style={{ backgroundColor: '#af99ff', padding: '2rem 0', textAlign: 'center' }}>
  <h2 style={{ fontSize: '4rem', color: '#1a202c' }} data-aos='fade-up' data-aos-delay='200' data-aos-anchor='.help-section'>
    Who we can help?
  </h2>
  <div
    style={{
   ...
   <div style={{backgroundColor:'#B5D0FF', padding: '32px', borderRadius: '10%', textAlign: 'center', width:'250px' }} data-aos='fade-right' data-aos-delay='200'>
  <img src='/graduate.png' alt='Recent Graduate' style={{ width: '7rem' }} />
  <h2 style={{ color: 'black', fontWeight: 'bold', fontSize: '4xl', marginTop: '1rem' }}>Recent Graduate</h2>
</div>
<div style={{backgroundColor:'#B5D0FF', padding: '32px', borderRadius: '10%', textAlign: 'center', width:'250px' }} data-aos='fade-right' data-aos-delay='200'>
  <img src='/job.png' alt='Job' style={{ width: '7rem' }} />
  <h2 style={{ color: 'black', fontWeight: 'bold', fontSize: '4xl', marginTop: '1rem' }}>Switching Jobs</h2>
</div>
<div style={{backgroundColor:'#B5D0FF', padding: '32px', borderRadius: '10%', textAlign: 'center', width:'250px' }} data-aos='fade-right' data-aos-delay='200'>
  <img src='/startup.png' alt='Startup' style={{ width: '7rem' }} />
  <h2 style={{ color: 'black', fontWeight: 'bold', fontSize: '4xl', marginTop: '1rem' }}>Budding Startup</h2>
</div>
<div style={{backgroundColor:'#B5D0FF', padding: '32px', borderRadius: '10%', textAlign: 'center', width:'250px' }} data-aos='fade-right' data-aos-delay='200'>
  <img src='/upskill.png' alt='Upskill' style={{ width: '7rem' }} />
  <h2 style={{ color: 'black', fontWeight: 'bold', fontSize: '4xl', marginTop: '1rem' }}>Upskilling</h2>
</div>
  </div>
  <div>
  <a
